  ...
  <div class="main-container">
    ...
    <form class="input-third" method="GET" action="index.php" style="display: flex; gap: 10px;">
       ...
       <div class="second-apprenant">
            <div class="retenu"> Liste des retenus </div>
            <div class="attente">
              <a href="index.php?menu=apprenant&action=attente_apprenants">   
               Liste d'attente
               </a>
            </div>
       </div>
                ...
                <td><?= htmlspecialchars($apprenant["matricule"]) ?></td>
                    ...
                    <div class="action-table">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                <li><a href="index.php?menu=apprenant&action=details_programme&matricule=<?= htmlspecialchars($apprenant['matricule']) ?>">Voir les détails de l'apprenant</a></li>
                                <li><a href="index.php?menu=apprenant&action=details_absence&matricule=<?= htmlspecialchars($apprenant['matricule']) ?>">Absence</a></li>
                            </ul>
                        </div>
                    </div>
                    </td>
      ...
      <form method="get" class="page-selector" style="display: flex; align-items: center;">
        ...
        >
          ...
          <div class="navigation">
            ...
            <a href="index.php?menu=apprenant&action=default&page=<?= $pagination['precedente'] . $pagination['url_params'] ?>" class="nav-button" title="Page précédente">
            <div class="nav-arrow">
                ...
                <?php foreach ($pagination['pages'] as $page): ?>
                    <a href="index.php?menu=apprenant&action=default&page=<?= $page . $pagination['url_params'] ?>" class="nav-button <?= $page == $pagination['page_actuelle'] ? 'active' : '' ?>">
                        <?= $page ?>
                    </a>
                <?php endforeach; ?>

                <?php if ($pagination['suivante']): ?>
                    <a href="index.php?menu=apprenant&action=default&page=<?= $pagination['suivante'] . $pagination['url_params'] ?>" class="nav-button" title="Page suivante">
                    <div class="nav-arrow">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
